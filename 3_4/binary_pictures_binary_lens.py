...
'''Directories'''
basedir = 'binary_pictures_binary_lens_YIGdubs2_100umx100um_alpha/'
...
epoch = epoch_init
if epoch_init>=0:
    checkpoint = torch.load('models/focus_binary_lens_YIGdubs2_100umx100um_alpha/' + 'model_e%d.pt' % (epoch_init))
...
'''Save .mat file'''
savemat("matlab/Msat100umalpha.mat", {"Msat": Msat.to(torch.device("cpu")).numpy().transpose()})
